...
func (p *rtCleaner) sync(ctx context.Context, key string, obj *v3.RoleTemplate) (runtime.Object, error) {
	_, span := tracing.StartSpanFromContext(ctx, "handling rt cleaner")
	defer span.End()

	span.AddEvent("cleaning up!")
	if key == "" || obj == nil {
		return nil, nil
	}
