...
type BasicAuthHandlerContextFunc func(ctx context.Context, key string, obj *v3.BasicAuth) (runtime.Object, error)
...
type BasicAuthControllerContext interface {
	AddHandlerContext(ctx context.Context, name string, handler BasicAuthHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, handler BasicAuthHandlerContextFunc) error
}
...
type BasicAuthInterfaceContext interface {
	AddHandlerContext(ctx context.Context, name string, handler BasicAuthHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync BasicAuthHandlerContextFunc) error
}
...
func (c *basicAuthController) AddHandlerContext(ctx context.Context, name string, handler BasicAuthHandlerContextFunc) error {
...
func (c *basicAuthController) AddClusterScopedHandlerContext(ctx context.Context, name, cluster string, handler BasicAuthHandlerContextFunc) error {
	controllerCtx, ok := c.GenericController.(controller.GenericControllerContext)
	if !ok {
		return fmt.Errorf("not controller context")
	}
...
func (s *basicAuthClient) AddHandlerContext(ctx context.Context, name string, sync BasicAuthHandlerContextFunc) error {
	return s.Controller().(BasicAuthControllerContext).AddHandlerContext(ctx, name, sync)
}
...
func (s *basicAuthClient) AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync BasicAuthHandlerContextFunc) error {
	return s.Controller().(BasicAuthControllerContext).AddClusterScopedHandlerContext(ctx, name, clusterName, sync)
}
