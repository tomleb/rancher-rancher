...
type SSHAuthHandlerContextFunc func(ctx context.Context, key string, obj *v3.SSHAuth) (runtime.Object, error)
...
type SSHAuthControllerContext interface {
	AddHandlerContext(ctx context.Context, name string, handler SSHAuthHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, handler SSHAuthHandlerContextFunc) error
}
...
type SSHAuthInterfaceContext interface {
	AddHandlerContext(ctx context.Context, name string, handler SSHAuthHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync SSHAuthHandlerContextFunc) error
}
...
func (c *sshAuthController) AddHandlerContext(ctx context.Context, name string, handler SSHAuthHandlerContextFunc) error {
...
func (c *sshAuthController) AddClusterScopedHandlerContext(ctx context.Context, name, cluster string, handler SSHAuthHandlerContextFunc) error {
	controllerCtx, ok := c.GenericController.(controller.GenericControllerContext)
	if !ok {
		return fmt.Errorf("not controller context")
	}
...
func (s *sshAuthClient) AddHandlerContext(ctx context.Context, name string, sync SSHAuthHandlerContextFunc) error {
	return s.Controller().(SSHAuthControllerContext).AddHandlerContext(ctx, name, sync)
}
...
func (s *sshAuthClient) AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync SSHAuthHandlerContextFunc) error {
	return s.Controller().(SSHAuthControllerContext).AddClusterScopedHandlerContext(ctx, name, clusterName, sync)
}
