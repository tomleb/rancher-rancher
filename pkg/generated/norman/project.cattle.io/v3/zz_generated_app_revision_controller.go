...
type AppRevisionHandlerContextFunc func(ctx context.Context, key string, obj *v3.AppRevision) (runtime.Object, error)
...
type AppRevisionControllerContext interface {
	AddHandlerContext(ctx context.Context, name string, handler AppRevisionHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, handler AppRevisionHandlerContextFunc) error
}
...
type AppRevisionInterfaceContext interface {
	AddHandlerContext(ctx context.Context, name string, handler AppRevisionHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync AppRevisionHandlerContextFunc) error
}
...
func (c *appRevisionController) AddHandlerContext(ctx context.Context, name string, handler AppRevisionHandlerContextFunc) error {
...
func (c *appRevisionController) AddClusterScopedHandlerContext(ctx context.Context, name, cluster string, handler AppRevisionHandlerContextFunc) error {
	controllerCtx, ok := c.GenericController.(controller.GenericControllerContext)
	if !ok {
		return fmt.Errorf("not controller context")
	}
...
func (s *appRevisionClient) AddHandlerContext(ctx context.Context, name string, sync AppRevisionHandlerContextFunc) error {
	return s.Controller().(AppRevisionControllerContext).AddHandlerContext(ctx, name, sync)
}
...
func (s *appRevisionClient) AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync AppRevisionHandlerContextFunc) error {
	return s.Controller().(AppRevisionControllerContext).AddClusterScopedHandlerContext(ctx, name, clusterName, sync)
}
