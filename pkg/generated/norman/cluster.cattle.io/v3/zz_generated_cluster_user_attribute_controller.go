...
type ClusterUserAttributeHandlerContextFunc func(ctx context.Context, key string, obj *v3.ClusterUserAttribute) (runtime.Object, error)
...
type ClusterUserAttributeControllerContext interface {
	AddHandlerContext(ctx context.Context, name string, handler ClusterUserAttributeHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, handler ClusterUserAttributeHandlerContextFunc) error
}
...
type ClusterUserAttributeInterfaceContext interface {
	AddHandlerContext(ctx context.Context, name string, handler ClusterUserAttributeHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync ClusterUserAttributeHandlerContextFunc) error
}
...
func (c *clusterUserAttributeController) AddHandlerContext(ctx context.Context, name string, handler ClusterUserAttributeHandlerContextFunc) error {
...
func (c *clusterUserAttributeController) AddClusterScopedHandlerContext(ctx context.Context, name, cluster string, handler ClusterUserAttributeHandlerContextFunc) error {
	controllerCtx, ok := c.GenericController.(controller.GenericControllerContext)
	if !ok {
		return fmt.Errorf("not controller context")
	}
...
func (s *clusterUserAttributeClient) AddHandlerContext(ctx context.Context, name string, sync ClusterUserAttributeHandlerContextFunc) error {
	return s.Controller().(ClusterUserAttributeControllerContext).AddHandlerContext(ctx, name, sync)
}
...
func (s *clusterUserAttributeClient) AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync ClusterUserAttributeHandlerContextFunc) error {
	return s.Controller().(ClusterUserAttributeControllerContext).AddClusterScopedHandlerContext(ctx, name, clusterName, sync)
}
