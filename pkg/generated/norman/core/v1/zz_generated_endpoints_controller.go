...
type EndpointsHandlerContextFunc func(ctx context.Context, key string, obj *v1.Endpoints) (runtime.Object, error)
...
type EndpointsControllerContext interface {
	AddHandlerContext(ctx context.Context, name string, handler EndpointsHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, handler EndpointsHandlerContextFunc) error
}
...
type EndpointsInterfaceContext interface {
	AddHandlerContext(ctx context.Context, name string, handler EndpointsHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync EndpointsHandlerContextFunc) error
}
...
func (c *endpointsController) AddHandlerContext(ctx context.Context, name string, handler EndpointsHandlerContextFunc) error {
...
func (c *endpointsController) AddClusterScopedHandlerContext(ctx context.Context, name, cluster string, handler EndpointsHandlerContextFunc) error {
	controllerCtx, ok := c.GenericController.(controller.GenericControllerContext)
	if !ok {
		return fmt.Errorf("not controller context")
	}
...
func (s *endpointsClient) AddHandlerContext(ctx context.Context, name string, sync EndpointsHandlerContextFunc) error {
	return s.Controller().(EndpointsControllerContext).AddHandlerContext(ctx, name, sync)
}
...
func (s *endpointsClient) AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync EndpointsHandlerContextFunc) error {
	return s.Controller().(EndpointsControllerContext).AddClusterScopedHandlerContext(ctx, name, clusterName, sync)
}
