...
type RoleBindingHandlerContextFunc func(ctx context.Context, key string, obj *v1.RoleBinding) (runtime.Object, error)
...
type RoleBindingControllerContext interface {
	AddHandlerContext(ctx context.Context, name string, handler RoleBindingHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, handler RoleBindingHandlerContextFunc) error
}
...
type RoleBindingInterfaceContext interface {
	AddHandlerContext(ctx context.Context, name string, handler RoleBindingHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync RoleBindingHandlerContextFunc) error
}
...
func (c *roleBindingController) AddHandlerContext(ctx context.Context, name string, handler RoleBindingHandlerContextFunc) error {
...
func (c *roleBindingController) AddClusterScopedHandlerContext(ctx context.Context, name, cluster string, handler RoleBindingHandlerContextFunc) error {
	controllerCtx, ok := c.GenericController.(controller.GenericControllerContext)
	if !ok {
		return fmt.Errorf("not controller context")
	}
...
func (s *roleBindingClient) AddHandlerContext(ctx context.Context, name string, sync RoleBindingHandlerContextFunc) error {
	return s.Controller().(RoleBindingControllerContext).AddHandlerContext(ctx, name, sync)
}
...
func (s *roleBindingClient) AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync RoleBindingHandlerContextFunc) error {
	return s.Controller().(RoleBindingControllerContext).AddClusterScopedHandlerContext(ctx, name, clusterName, sync)
}
