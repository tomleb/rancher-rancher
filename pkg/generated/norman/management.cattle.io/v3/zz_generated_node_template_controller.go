...
type NodeTemplateHandlerContextFunc func(ctx context.Context, key string, obj *v3.NodeTemplate) (runtime.Object, error)
...
type NodeTemplateControllerContext interface {
	AddHandlerContext(ctx context.Context, name string, handler NodeTemplateHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, handler NodeTemplateHandlerContextFunc) error
}
...
type NodeTemplateInterfaceContext interface {
	AddHandlerContext(ctx context.Context, name string, handler NodeTemplateHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync NodeTemplateHandlerContextFunc) error
}
...
func (c *nodeTemplateController) AddHandlerContext(ctx context.Context, name string, handler NodeTemplateHandlerContextFunc) error {
...
func (c *nodeTemplateController) AddClusterScopedHandlerContext(ctx context.Context, name, cluster string, handler NodeTemplateHandlerContextFunc) error {
	controllerCtx, ok := c.GenericController.(controller.GenericControllerContext)
	if !ok {
		return fmt.Errorf("not controller context")
	}
...
func (s *nodeTemplateClient) AddHandlerContext(ctx context.Context, name string, sync NodeTemplateHandlerContextFunc) error {
	return s.Controller().(NodeTemplateControllerContext).AddHandlerContext(ctx, name, sync)
}
...
func (s *nodeTemplateClient) AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync NodeTemplateHandlerContextFunc) error {
	return s.Controller().(NodeTemplateControllerContext).AddClusterScopedHandlerContext(ctx, name, clusterName, sync)
}
