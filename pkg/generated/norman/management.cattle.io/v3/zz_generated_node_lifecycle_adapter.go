...
func (w *nodeLifecycleConverter) CreateContext(_ context.Context, obj *v3.Node) (runtime.Object, error) {
	return w.lifecycle.Create(obj)
}

func (w *nodeLifecycleConverter) RemoveContext(_ context.Context, obj *v3.Node) (runtime.Object, error) {
	return w.lifecycle.Remove(obj)
}

func (w *nodeLifecycleConverter) UpdatedContext(_ context.Context, obj *v3.Node) (runtime.Object, error) {
...
type NodeLifecycleContext interface {
	CreateContext(ctx context.Context, obj *v3.Node) (runtime.Object, error)
	RemoveContext(ctx context.Context, obj *v3.Node) (runtime.Object, error)
	UpdatedContext(ctx context.Context, obj *v3.Node) (runtime.Object, error)
}
...
func (w *nodeLifecycleAdapter) CreateContext(ctx context.Context, obj runtime.Object) (runtime.Object, error) {
	o, err := w.lifecycle.CreateContext(ctx, obj.(*v3.Node))
	if o == nil {
		return nil, err
	}
	return o, err
...
func (w *nodeLifecycleAdapter) FinalizeContext(ctx context.Context, obj runtime.Object) (runtime.Object, error) {
	o, err := w.lifecycle.RemoveContext(ctx, obj.(*v3.Node))
	if o == nil {
		return nil, err
	}
	return o, err
...
func (w *nodeLifecycleAdapter) UpdatedContext(ctx context.Context, obj runtime.Object) (runtime.Object, error) {
	o, err := w.lifecycle.UpdatedContext(ctx, obj.(*v3.Node))
	if o == nil {
		return nil, err
	}
	return o, err
...
func NewNodeLifecycleAdapterContext(name string, clusterScoped bool, client NodeInterface, l NodeLifecycleContext) NodeHandlerContextFunc {
	...
	return func(ctx context.Context, key string, obj *v3.Node) (runtime.Object, error) {
