...
type PodSecurityAdmissionConfigurationTemplateHandlerContextFunc func(ctx context.Context, key string, obj *v3.PodSecurityAdmissionConfigurationTemplate) (runtime.Object, error)
...
type PodSecurityAdmissionConfigurationTemplateControllerContext interface {
	AddHandlerContext(ctx context.Context, name string, handler PodSecurityAdmissionConfigurationTemplateHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, handler PodSecurityAdmissionConfigurationTemplateHandlerContextFunc) error
}
...
type PodSecurityAdmissionConfigurationTemplateInterfaceContext interface {
	AddHandlerContext(ctx context.Context, name string, handler PodSecurityAdmissionConfigurationTemplateHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync PodSecurityAdmissionConfigurationTemplateHandlerContextFunc) error
}
...
func (c *podSecurityAdmissionConfigurationTemplateController) AddHandlerContext(ctx context.Context, name string, handler PodSecurityAdmissionConfigurationTemplateHandlerContextFunc) error {
...
func (c *podSecurityAdmissionConfigurationTemplateController) AddClusterScopedHandlerContext(ctx context.Context, name, cluster string, handler PodSecurityAdmissionConfigurationTemplateHandlerContextFunc) error {
	controllerCtx, ok := c.GenericController.(controller.GenericControllerContext)
	if !ok {
		return fmt.Errorf("not controller context")
	}
...
func (s *podSecurityAdmissionConfigurationTemplateClient) AddHandlerContext(ctx context.Context, name string, sync PodSecurityAdmissionConfigurationTemplateHandlerContextFunc) error {
	return s.Controller().(PodSecurityAdmissionConfigurationTemplateControllerContext).AddHandlerContext(ctx, name, sync)
}
...
func (s *podSecurityAdmissionConfigurationTemplateClient) AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync PodSecurityAdmissionConfigurationTemplateHandlerContextFunc) error {
	return s.Controller().(PodSecurityAdmissionConfigurationTemplateControllerContext).AddClusterScopedHandlerContext(ctx, name, clusterName, sync)
}
