...
type RancherUserNotificationHandlerContextFunc func(ctx context.Context, key string, obj *v3.RancherUserNotification) (runtime.Object, error)
...
type RancherUserNotificationControllerContext interface {
	AddHandlerContext(ctx context.Context, name string, handler RancherUserNotificationHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, handler RancherUserNotificationHandlerContextFunc) error
}
...
type RancherUserNotificationInterfaceContext interface {
	AddHandlerContext(ctx context.Context, name string, handler RancherUserNotificationHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync RancherUserNotificationHandlerContextFunc) error
}
...
func (c *rancherUserNotificationController) AddHandlerContext(ctx context.Context, name string, handler RancherUserNotificationHandlerContextFunc) error {
...
func (c *rancherUserNotificationController) AddClusterScopedHandlerContext(ctx context.Context, name, cluster string, handler RancherUserNotificationHandlerContextFunc) error {
	controllerCtx, ok := c.GenericController.(controller.GenericControllerContext)
	if !ok {
		return fmt.Errorf("not controller context")
	}
...
func (s *rancherUserNotificationClient) AddHandlerContext(ctx context.Context, name string, sync RancherUserNotificationHandlerContextFunc) error {
	return s.Controller().(RancherUserNotificationControllerContext).AddHandlerContext(ctx, name, sync)
}
...
func (s *rancherUserNotificationClient) AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync RancherUserNotificationHandlerContextFunc) error {
	return s.Controller().(RancherUserNotificationControllerContext).AddClusterScopedHandlerContext(ctx, name, clusterName, sync)
}
