...
type ClusterTemplateHandlerContextFunc func(ctx context.Context, key string, obj *v3.ClusterTemplate) (runtime.Object, error)
...
type ClusterTemplateControllerContext interface {
	AddHandlerContext(ctx context.Context, name string, handler ClusterTemplateHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, handler ClusterTemplateHandlerContextFunc) error
}
...
type ClusterTemplateInterfaceContext interface {
	AddHandlerContext(ctx context.Context, name string, handler ClusterTemplateHandlerContextFunc) error
	AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync ClusterTemplateHandlerContextFunc) error
}
...
func (c *clusterTemplateController) AddHandlerContext(ctx context.Context, name string, handler ClusterTemplateHandlerContextFunc) error {
...
func (c *clusterTemplateController) AddClusterScopedHandlerContext(ctx context.Context, name, cluster string, handler ClusterTemplateHandlerContextFunc) error {
	controllerCtx, ok := c.GenericController.(controller.GenericControllerContext)
	if !ok {
		return fmt.Errorf("not controller context")
	}
...
func (s *clusterTemplateClient) AddHandlerContext(ctx context.Context, name string, sync ClusterTemplateHandlerContextFunc) error {
	return s.Controller().(ClusterTemplateControllerContext).AddHandlerContext(ctx, name, sync)
}
...
func (s *clusterTemplateClient) AddClusterScopedHandlerContext(ctx context.Context, name, clusterName string, sync ClusterTemplateHandlerContextFunc) error {
	return s.Controller().(ClusterTemplateControllerContext).AddClusterScopedHandlerContext(ctx, name, clusterName, sync)
}
